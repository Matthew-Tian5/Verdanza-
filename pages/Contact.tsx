    ...
    <div className="pt-32 pb-20 min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <div className="space-y-8 mb-12">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-white shadow-sm flex items-center justify-center text-verdanza-dark shrink-0">
                  <Mail />
                </div>
                <div>
            ...
            {/* Socials */}
            <div>
              <h3 className="font-bold text-charcoal text-lg mb-4">Follow Us</h3>
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 rounded-full bg-charcoal text-white flex items-center justify-center hover:bg-verdanza hover:text-charcoal transition-colors">
                  <Linkedin size={20} />
                </a>
                <a href="#" className="w-10 h-10 rounded-full bg-charcoal text-white flex items-center justify-center hover:bg-verdanza hover:text-charcoal transition-colors">
                  <Instagram size={20} />
          ...
          >
            <h2 className="text-2xl font-bold text-charcoal mb-6">Join Us</h2>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-4 rounded-xl bg-charcoal text-white font-bold text-lg hover:bg-black transition-all shadow-lg shadow-verdanza/20 flex items-center justify-center gap-2 group"
              >
                Send Message
